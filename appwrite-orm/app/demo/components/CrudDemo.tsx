...
import { Database, Plus, Search, Trash2, RefreshCw, CheckCircle2, AlertCircle } from "lucide-react";
      ...
      >
        ...
        <div className="space-y-3 font-mono text-sm">
          <div className="bg-white/20 dark:bg-gray-900/20 p-4 rounded-lg backdrop-blur-sm border border-white/20 dark:border-gray-800/20">
            <p className="text-gray-600 dark:text-gray-400 mb-2">// Initialize ORM in development mode</p>
          ...
          <div className="bg-white/20 dark:bg-gray-900/20 p-4 rounded-lg backdrop-blur-sm border border-white/20 dark:border-gray-800/20">
            ...
            <code className="text-black dark:text-white">
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;priority: {'{'} type: ['low','medium','high'] {'}'}<br/>
              &nbsp;&nbsp;{'}'}<br/>
              {'}'}]);
            </code>
          </div>
